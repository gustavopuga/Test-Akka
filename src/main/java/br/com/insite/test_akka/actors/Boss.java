...
import br.com.insite.test_akka.actors.factories.WorkerFactory;
...
public class Boss extends UntypedActor {
	...
	private static final Logger log = Logger.getLogger(Boss.class);
	...
	public Boss(int numberOfWorkers, int numberOfMessages,
